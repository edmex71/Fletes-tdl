...
// Ejecutar detección de casetas

function ejecutarDeteccionCasetas(routeCoords){
...
let lon=routeCoords[i][0]
let lat=routeCoords[i][1]
...
function buscarCasetasAutopista(routeCoords){
