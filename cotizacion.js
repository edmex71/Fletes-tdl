...
let consumo=km/rendimiento[tipo]
let dieselCosto=consumo*diesel

let casetas=window.casetasTotal||0

let base=dieselCosto+casetas+operativo

let bajo=redondear100(base+km*22)
let medio=redondear100(base+km*32)
let alto=redondear100(base+km*38)
